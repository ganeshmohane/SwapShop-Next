...
<body>
<div class="main">
   <center><h2>Seller Dashboard</h2></center><hr>
<?php
    ...
    <div class="btns">
         ...
         <?php echo "welcome ". $_SESSION['name']; echo " ".$_SESSION['surname'];?><br>
                 ...
                 $con = mysqli_connect($server,$username,$password,$dbname);
                  ...
                  {
                     $sql="SELECT * FROM Seller_register WHERE s_id=$id "; 
                     $result=mysqli_query($con,$sql);
                     $row=mysqli_fetch_array($result);
                     ?>
               <h3><b><i><?php echo"".$row["s_firstname"];echo" ".$row["s_surname"];echo"'s Details";?></i></b></h3>
               <hr>
               <div class="left-column">
                  <p><label>Username:</label> <?php echo $row["s_username"];?></p>
                  <p><label>Gender:</label> <?php echo $row["s_gender"];?></p>
                  <p><label>College:</label> <?php echo $row["s_college"];?></p>
                  <p><label>Stream:</label> <?php echo $row["s_stream"];?></p>
                  <p><label>Branch:</label> <?php echo $row["s_branch"];?></p>
               </div>
               <div class="right-column">
                  <p><label>Semester:</label> <?php echo $row["s_sem"];?></p>
                  <p><label>Email Id:</label> <?php echo $row["s_email"];?></p>
                  <p><label>Phone No:</label> <?php echo $row["s_phone"];?></p>
                  <p><label>Verified:</label> <?php echo $row["s_email_verified_at"] ? 'Yes' : 'No';?></p>
               </div>
               <div class="clear"></div>
               <hr>
